...
class Informations() :
    def __init__(self,conditionIndividus = "", conditionFamilles = "", date_reference=datetime.date.today(), qf = True, inscriptions = True, messages = True, infosMedicales = True, cotisationsManquantes = True, piecesManquantes = True, questionnaires = True, scolarite = True,):
        self.conditionIndividus = conditionIndividus
        self.conditionFamilles = conditionFamilles
    ...
    def GetDictIndividus(self):
        ...
        %s ;""" % (", ".join(listeNomsChamps), self.conditionIndividus)
    ...
    def GetRattachements(self):
        ...
        FROM rattachements %s
        ORDER BY IDcategorie, titulaire ;""" % self.conditionIndividus
        listeDonnees = self.ReadDB(req)
    ...
    def GetLiens(self):
        ...
        FROM liens
        %s
        ORDER BY IDtype_lien;"""  % self.conditionFamilles
        listeDonnees = self.ReadDB(req)
        dictLiens = {}
    ...
    def RechercheQF(self):
        ...
        FROM quotients %s;"""  % self.conditionFamilles
        listeDonnees = self.ReadDB(req)
    ...
    def RechercheInfosMedicales(self):
        ...
        %s
        ORDER BY IDprobleme;"""  % self.conditionIndividus
        listeDonnees = self.ReadDB(req)
...
# ---------------------------------------------------------------------------------------------------------------------------------
    ...
    def EnregistreDansDB(self, nomFichier="Temp/database.dat"):
        ...
        req = """SELECT IDindividu, photo FROM photos %s;""" % self.conditionIndividus
        db.ExecuterReq(req)
        ...
        db = GestionDB.DB()
        req = """SELECT IDindividu, IDcivilite, nom, prenom FROM individus %s;""" % self.conditionIndividus
        db.ExecuterReq(req)
