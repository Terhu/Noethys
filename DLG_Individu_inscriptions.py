...
# -*- coding: iso-8859-15 -*-
#------------------------------------------------------------------------
# Matthania JB : un seul point de greffage import aOL_IndividuInscriptions
...
import wx
import aOL_IndividuInscriptions as OL_Inscriptions
import OL_Contrats
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.IDindividu = 6163
        self.dictFamillesRattachees = {6163: {'listeNomsTitulaires': [u'ABALAIN Jessica'], 'nomsTitulaires': u'ABALAIN Jessica', 'IDcompte_payeur': 6163, 'nomCategorie': u'repr\xe9sentant', 'IDcategorie': 1},6164: {'listeNomsTitulaires': [u'listeJessica'], 'nomsTitulaires': u'nomJessica', 'IDcompte_payeur': 6164, 'nomCategorie': u'repr\xe9sentant', 'IDcategorie': 1}}
        self.ctrl = Panel(panel, IDindividu=self.IDindividu,  dictFamillesRattachees= self.dictFamillesRattachees)
##        self.ctrl.MAJ() 
