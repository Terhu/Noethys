...
# point d'ancrage Matthania, pour aUTILS_Facturation
#------------------------------------------------------------------------
...
import aUTILS_Facturation as UTILS_Facturation
...
class Dialog(wx.Dialog):
    ...
    def OnBoutonApercu(self, event): 
        ...
        #    print (nom, valeur)
        print "liste factures  = ", listeIDfacture
        print "dictOptions = " , dictOptions
