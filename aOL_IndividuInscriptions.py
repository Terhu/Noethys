...
class ListView(FastObjectListView):
    ...
    def InitObjectListView(self):            
        ...
        if self.nbreFamilles > 1 :
            liste_Colonnes = [
                ...
                ColumnDefn(_(u"Catégorie de tarifs"), 'left', 110, "nom_categorie_tarif", typeDonnee="texte"),
            ...
            liste_Colonnes = [
                ...
                ColumnDefn(_(u"Catégorie de tarifs"), 'left', 100, "nom_categorie_tarif", typeDonnee="texte"),
                ]
    ...
    def Ajouter(self,event):
        dlg= aDLG_InscriptionMenu.DlgMenu(self,self.Selection(),"ajouter",IDindividu=self.IDindividu, dictFamillesRattachees=self.dictFamillesRattachees)

    def Modifier(self,event):
        dlg= aDLG_InscriptionMenu.DlgMenu(self,self.Selection(),"modifier",IDindividu=self.IDindividu, dictFamillesRattachees=self.dictFamillesRattachees)

    def Supprimer(self,event):
        dlg= aDLG_InscriptionMenu.DlgMenu(self,self.Selection(),"supprimer",IDindividu=self.IDindividu, dictFamillesRattachees=self.dictFamillesRattachees)
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.dictFamillesRattachees = {6163: {'listeNomsTitulaires': [u'ABALAIN Jessica'], 'nomsTitulaires': u'ABALAIN Jessica', 'IDcompte_payeur': 6163, 'nomCategorie': u'repr\xe9sentant', 'IDcategorie': 1}}
