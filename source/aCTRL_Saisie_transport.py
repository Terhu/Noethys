...
DICT_CONTROLES = {
    ...
    "generalites" : [
        ...
        {"code" : "compagnie_navette", "label" : _(u"Matthania"), "ctrl" : "CTRL_Compagnies(self, categorie='navette')" },
        {"code" : "compagnie_train", "label" : _(u"Ligne"), "ctrl" : "CTRL_Compagnies(self, categorie='train')" },
    ...
    "depart" : [
        {"code" : "date", "label" : _(u"Date"), "ctrl" : "CTRL_Date(self)" },
...
DICT_CATEGORIES = {
    ...
    "voiture" : {   "label" : _(u"Voiture Parents"), "image" : "Voiture", "type" : "localisations", "controles" : {
                                    "generalites" : ["observations",],
                                    "depart" : [],
                                    "arrivee" : ["date"],
                                    },},

    "intercamp" : {   "label" : _(u"Inter-camp"), "image" : "Horloge", "type" : "localisations", "controles" : {
                                    "generalites" : ["observations",],
                                    "depart" : ["date"],
                                    "arrivee" : ["date"],
                                    },},
    ...
    "navette" : {       "label" : _(u"Navette du Camp"), "image" : "Navette", "type" : "lignes", "controles" : {
                                    "generalites" : ["ligne_navette", "observations"],
...
class CTRL_Categorie(wx.combo.BitmapComboBox):
    def __init__(self, parent, size=(-1,  -1)):
        wx.combo.BitmapComboBox.__init__(self, parent, -1, size=size, style=wx.CB_READONLY)
        self.parent = parent
...
class CTRL(wx.Panel):
    ...
    def Validation(self):
        ...
        if self.categorie in ("voiture","navette","intercamp"):
            return True
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.ctrl = CTRL(panel, IDtransport=518, IDindividu=11316)
