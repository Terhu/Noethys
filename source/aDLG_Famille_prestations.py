...
# -*- coding: iso-8859-15 -*-
#------------------------------------------------------------------------
# Application :    Noethys, gestion multi-activités, seulement modifié pour chaîner sur aOL_Perstations
...
class Panel(wx.Panel):
    def __init__(self, parent, IDfamille=None):
        ...
        # OL Prestations JB
        self.listviewAvecFooter = aOL_Prestations.ListviewAvecFooter(self, kwargs={"IDfamille" : IDfamille})
        self.ctrl_prestations = self.listviewAvecFooter.GetListview()
        self.ctrl_recherche = aOL_Prestations.CTRL_Outils(self, listview=self.ctrl_prestations, afficherCocher=True)
