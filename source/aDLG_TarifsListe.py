...
# Gestion de la liste Noms de tarifs
#------------------------------------------------------------------------
...
import CTRL_Bandeau
import aOL_TarifsListe

class Dialog(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, -1, style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.MAXIMIZE_BOX|wx.MINIMIZE_BOX|wx.THICK_FRAME)
        self.parent = parent
        intro = (u"Outil de Gestion des noms et du contenu des Tarifs. NbCamps affectes à chaque tarif. NbLignes d'articles composant chaque tarif")
        ...
        self.ctrl_listview = aOL_TarifsListe.ListView(self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = aOL_TarifsListe.CTRL_Outils(self, listview=self.ctrl_listview)
        ...
        #self.ctrl_annee.SetValue(wx.DateTime.GetYear(wx.DateTime.Now())
    ...
    def __set_properties(self):
        self.SetTitle(_(u"aDLG_TarifsListe"))
        self.ctrl_listview.SetToolTipString(_(u"Un double clic est pour modifier le contenu de la ligne"))
        self.bouton_ajouter.SetToolTipString(_(u"Créer un nouveau Tarif"))
        self.bouton_modifier.SetToolTipString(_(u"Modifier un tarif sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Supprimer un tarif non affecté à un camp et sélectionné dans la liste"))
