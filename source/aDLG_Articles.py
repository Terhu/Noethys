...
# Gestion de la table Articles définissant les lignes de tarification
#------------------------------------------------------------------------
...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des articles (regroupement de lignes sur les factures).")
        titre = _(u"Liste des Articles")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro,  hauteurHtml=15, nomImage="Images/22x22/Smiley_nul.png")
        self.ctrl_listview = aOL_Articles.ListView(self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = aOL_Articles.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_(u"aDLG_Articles"))
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un article"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier l'article sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer l'article sélectionné dans la liste"))
