...
class Dialog(wx.Dialog):
    def __init__(self, parent):
        ...
        self.parent = parent
        intro = _(u"Vous pouvez ici saisir, modifier ou supprimer des blocs (regroupement de lignes sur les factures).")
        titre = _(u"Gestion des BlocsFacture")
        self.ctrl_bandeau = CTRL_Bandeau.Bandeau(self, titre=titre, texte=intro,  hauteurHtml=15, nomImage="Images/22x22/Smiley_nul.png")
        self.ctrl_listview = aOL_BlocsFacture.ListView(self,self, id=-1, style=wx.LC_REPORT|wx.SUNKEN_BORDER|wx.LC_SINGLE_SEL|wx.LC_HRULES|wx.LC_VRULES)
        self.ctrl_listview.MAJ()
        self.ctrl_recherche = aOL_BlocsFacture.CTRL_Outils(self, listview=self.ctrl_listview)
    ...
    def __set_properties(self):
        self.SetTitle(_(u"aDLG_BlocsFacture"))
        self.ctrl_listview.SetToolTipString(_(u"Double Cliquez pour choisir et fermer la fenêtre"))
        self.bouton_ajouter.SetToolTipString(_(u"Cliquez ici pour ajouter un bloc"))
        self.bouton_modifier.SetToolTipString(_(u"Cliquez ici pour modifier le bloc sélectionné dans la liste"))
        self.bouton_supprimer.SetToolTipString(_(u"Cliquez ici pour supprimer le bloc sélectionné dans la liste"))
